...
if __name__ == '__main__':
    ...
    while(step == "rectifyambient"):
        ...
        safemkdirs(outLeft)
        safemkdirs(outRight)
        execute("ActiveLighting/ActiveLighting4 rectify "+outLeft+" "+intrinsics[0]+" "+distortion[0]+" "+rotation[0]+" "+projection[0]+" "+os.path.join(scenedir,"orig/ambient/L*/left/*.JPG"))
        execute("ActiveLighting/ActiveLighting4 rectify "+outRight+" "+intrinsics[1]+" "+distortion[1]+" "+rotation[1]+" "+projection[1]+" "+os.path.join(scenedir,"orig/ambient/L*/right/*.JPG"))
	...
	if(os.path.exists(os.path.join(scenedir,"orig/ambientBall"))):
		...
		safemkdirs(outLeft)
		safemkdirs(outRight)
		execute("ActiveLighting/ActiveLighting4 rectify "+outLeft+" "+intrinsics[0]+" "+distortion[0]+" "+rotation[0]+" "+projection[0]+" "+os.path.join(scenedir,"orig/ambientBall/L*/left/*.JPG"))
		execute("ActiveLighting/ActiveLighting4 rectify "+outRight+" "+intrinsics[1]+" "+distortion[1]+" "+rotation[1]+" "+projection[1]+" "+os.path.join(scenedir,"orig/ambientBall/L*/right/*.JPG"))
	else:
